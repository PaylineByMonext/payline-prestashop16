...
class paylineSDK{
	...
	private $posData;
	private $paymentMeansLogos = array(
	    '3XCB' => 'p_logo_3xcb.png',
	    '3XONEY' => 'p_logo_3xoney.png',
	    '1EURO' => 'p_logo_1euro.png',
	    '1EURO.COM' => 'p_logo_1euro.png',
	    'AURORE' => 'p_logo_aurore.png',
	    '3XONEY_SF' => 'p_logo_3xfacilipaycb.png',
	    '4XONEY' => 'p_logo_4xoney.png',
	    '4XONEY_SF' => 'p_logo_4xfacilipaycb.png',
	    'AMEX' => 'p_logo_amex.png',
	    'AMEX-ONE CLICK' => 'p_logo_amex_one_clic.png',
	    'AMEX-REC BILLING' => 'p_logo_amex_rec.png',
	    'ANCV' => 'p_logo_ancv.png',
	    'BC/MC' => 'p_logo_bcmc.png',
	    'BCMC' => 'p_logo_bcmc.png',
	    'BUYSTER' => 'p_logo_buyster.png',
	    'CASINO' => 'p_logo_casino.png',
	    'CB/VISA/MASTERCARD' => 'p_logo_cb_visa_mastercard.png',
	    'CB/MC PASS' => 'p_logo_cbpass.png',
	    'CB' => 'p_logo_cb_visa_mastercard.png',
	    'CDGP' => 'p_logo_cdgp.png',
	    'COFINOGA' => 'p_logo_cofinoga.png',
	    'CYRILLUS' => 'p_logo_cyrillus.png',
	    'DINERS' => 'p_logo_diners.png',
	    'DISCOVER' => 'p_logo_discover.png',
	    'ELV' => 'p_logo_elv.png',
	    'FNAC' => 'p_logo_fnac.png',
	    'GIROPAY' => 'p_logo_giropay.png',
	    'IDEAL' => 'p_logo_ideal.png',
	    'ILLICADO' => 'p_logo_illicado.png',
	    'JCB' => 'p_logo_jcb.png',
	    'KANGOUROU' => 'p_logo_kangourou.png',
	    'KLARNA' => 'p_logo_klarna.png',
	    'LEETCHI' => 'p_logo_leetchi.png',
	    'LYDIA' => 'p_logo_lydia.png',
	    'MAESTRO' => 'p_logo_maestro.png',
	    'MANDARINE' => 'p_logo_mandarine.png',
	    'MASTERPASS' => 'p_logo_masterpass.png',
	    'MAXICHEQUE' => 'p_logo_maxicheque.png',
	    'VISA/MASTERCARD' => 'p_logo_visa_mastercard.png',
	    'MCVISA' => 'p_logo_visa_mastercard.png',
	    'MONEYCLIC' => 'p_logo_moneyclic.png',
	    'EMONEO' => 'p_logo_moneo.png',
	    'NEOSURF' => 'p_logo_neosurf.png',
	    'NETELLER' => 'p_logo_neteller.png',
	    'OKSHOPPING' => 'p_logo_okshopping.png',
	    'PASS' => 'p_logo_pass.png',
	    'CBPASS' => 'p_logo_pass.png',
	    'PAYFAIR' => 'p_logo_payfair.png',
	    'PAYLIB' => 'p_logo_paylib.png',
	    'PAYPAL' => 'p_logo_paypal.png',
	    'PAYSAFECARD' => 'p_logo_paysafecard.png',
	    'POSTFINANCE' => 'p_logo_postfinance.png',
	    'TICKETSURF' => 'p_logo_premium.png',
	    'PRINTEMPS' => 'p_logo_printemps.png',
	    'PRZELEWY24' => 'p_logo_przelewy24.png',
	    'SACARTE' => 'p_logo_sacarte.png',
	    'SDD' => 'p_logo_sdd.png',
	    'SKRILL(MONEYBOOKERS)' => 'p_logo_skrill.png',
	    'SOFORT' => 'p_logo_sofort.png',
	    'SWITCH' => 'p_logo_switch.png',
	    'SURCOUF' => 'p_logo_surcouf.png',
	    'TOTALGR' => 'p_logo_totalgr.png',
	    'UKASH' => 'p_logo_ukash.png',
	    'WEXPAY' => 'p_logo_wexpay.png',
	    'YANDEX' => 'p_logo_yandex.png',
	    'YAPITAL' => 'p_logo_yapital.png',
	    'VISAPREPAID' => 'p_logo_visaprepaid.png',
	    'FCB3X' => 'p_logo_fcb3x.png',
	    'FCB4X' => 'p_logo_fcb4x.png',
	    'PRESTO' => 'p_logo_presto.png'
	);
	private $environment;
	...
	function __construct($merchant_id, $access_key, $proxy_host, $proxy_port, $proxy_login, $proxy_password, $environment, $pathLog = null) {
		...
		$this->header_soap['stream_context'] = stream_context_create(
	        array(
	            'ssl' => array(
	                'verify_peer' => false,
	...
	*/
	...
	public function doWebPayment($array){
		...
		if(!isset($array['contracts']) || !isset($array['contracts'][0]) || !strlen($array['contracts'][0])) $array['contracts'] = '';
		if(!isset($array['secondContracts']) || !isset($array['secondContracts'][0]) || !strlen($array['secondContracts'][0])) $array['secondContracts'] = '';
		if(!isset($array['walletContracts']) || !isset($array['walletContracts'][0]) || !strlen($array['walletContracts'][0])) $array['walletContracts'] = '';
		if(!isset($array['buyer']))$array['buyer'] = null;
		if(!isset($array['billingAddress']))$array['billingAddress'] = null;
		if(!isset($array['shippingAddress']))$array['shippingAddress'] = null;
	...
	public function getMerchantSettingsToArray($array){
		...
		*/
		...
		if (!empty($getMerchantSettingsRes['result']['code']) && $getMerchantSettingsRes['result']['code'] != paylineSDK::ERR_CODE) {
